...
An example of where this might be used is with Istio. For more information, see [this section.](../../istio/configuration/selectors-and-scrape-configurations.md)
...
As part of the chart deployment options, you can opt to increase the number of replicas of the Alertmanager deployed onto your cluster. The replicas can all be managed using the same underlying Alertmanager Config Secret. For more information on the Alertmanager Config Secret, refer to [this section.](advanced/alertmanager.md#multiple-alertmanager-replicas)

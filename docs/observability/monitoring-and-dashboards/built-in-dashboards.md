...
要查看和自定义用于支持 Grafana 仪表板的 PromQL 查询，请参阅[此页面](customizing-dashboard/customize-grafana-dashboard.md)。

### 持久化 Grafana 仪表板

要创建持久化 Grafana 仪表板，请参阅[此页面](customizing-dashboard/create-persistent-grafana-dashboard.md)。
...
有关在 Rancher 中配置 Alertmanager 的更多信息，请参阅[此页面](configuration/advanced/alertmanager.md)。
...
有关在 Rancher 中配置 PrometheusRule 的更多信息，请参阅[此页面](configuration/advanced/prometheusrules.md)。

...
有关详细信息，请参阅 [Logging](logging/logging.md)。

## Monitoring

你可以使用 Rancher，通过业界领先并开源的 [Prometheus](https://prometheus.io/) 来监控集群节点、Kubernetes 组件和软件部署的状态和进程。有关详细信息，请参阅 [Monitoring](monitoring-and-dashboards/monitoring-and-alerting.md)。

...
As a prerequisite, you must create a [secret](../../security/secrets-hub.md) or [configmap](../../cluster-admin/kubernetes-resources/configmaps.md) to be the source of the audit policy.
...
Rancher Dashboard provides an easy-to-use form for creating the [secret](../../security/secrets-hub.md) or [configmap](../../cluster-admin/kubernetes-resources/configmaps.md).

...
Optional: You can configure which namespaces data scraping occurs in by setting the Helm chart options described in [Selectors & Scrape Configs](../configuration/selectors-and-scrape-configurations.md).

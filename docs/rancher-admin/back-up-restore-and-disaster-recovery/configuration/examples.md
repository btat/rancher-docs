...
>**Note:** Refer to the [backup config reference page](backup.md) for more information on configuring the options below.
...
This example shows that the AWS credential secret does not have to be provided to create a backup if the nodes running `rancher-backup` have [these permissions for access to S3.](backup.md#iam-permissions-for-ec2-nodes-to-access-s3)
...
>**Note:** Refer to the [restore config reference page](restore.md) for more information on configuring the options below.
...
This example shows that the AWS credential secret does not have to be provided to restore from backup if the nodes running `rancher-backup` have [these permissions for access to S3.](backup.md#iam-permissions-for-ec2-nodes-to-access-s3)

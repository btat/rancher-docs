...
| -------------- | -------------- |
| Credential Secret | Choose the credentials for S3 from your secrets in Rancher. [Example](backup.md#example-credentialsecret). |
...
For information about creating storage classes refer to [this section.](../../../cluster-admin/manage-clusters/persistent-storage/dynamically-provision-new-storage.md)
...
Select an existing Persistent Volume (PV) that will be used to store your backups. For information about creating PersistentVolumes in Rancher, refer to [this section.](../../../cluster-admin/manage-clusters/persistent-storage/set-up-existing-storage.md#2-add-a-persistentvolume-that-refers-to-the-persistent-storage)

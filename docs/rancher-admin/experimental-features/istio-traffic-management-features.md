...
> **Prerequisite:** Turning on this feature does not enable Istio. A cluster administrator needs to [enable Istio for the cluster](../../observability/istio/guides/guides.md) in order to use the feature.

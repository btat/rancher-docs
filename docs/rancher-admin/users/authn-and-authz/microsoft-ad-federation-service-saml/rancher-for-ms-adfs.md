...
After you complete [Configuring Microsoft AD FS for Rancher](ms-adfs-for-rancher.md), enter your Active Directory Federation Service (AD FS) information into Rancher so that AD FS users can authenticate with Rancher.

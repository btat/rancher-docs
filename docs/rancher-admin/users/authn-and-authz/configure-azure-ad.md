...
管理员需要在迁移下述端点之前创建一个 [Rancher 备份](../../back-up-restore-and-disaster-recovery/back-up.md)。
...
1. 如果管理员想要回滚，我们建议他们使用正确的恢复流程。有关参考信息，请参阅[备份文档](../../back-up-restore-and-disaster-recovery/back-up.md)、[恢复文档](../../back-up-restore-and-disaster-recovery/restore.md)和[示例](../../back-up-restore-and-disaster-recovery/configuration/examples.md)。
...
>    - 使用另一个第三方身份认证系统并在 Rancher 中进行设置。请参阅[身份验证文档](authn-and-authz.md)，了解如何配置其他开放式身份验证提供程序。

...
Admins should create a [Rancher backup](../../back-up-restore-and-disaster-recovery/back-up.md) before they commit to the endpoint migration described below.
...
1. Admins are encouraged to use the proper restore process if they want to go back. Please see [backup docs](../../back-up-restore-and-disaster-recovery/back-up.md), [restore docs](../../back-up-restore-and-disaster-recovery/restore.md), and [examples](../../back-up-restore-and-disaster-recovery/configuration/examples.md) for reference.
...
>- If you don't wish to upgrade to v2.7.0+ after the Azure AD Graph API is retired, you'll need to either:
    ...
    - Use another third-party auth system and set that up in Rancher. Please see the [authentication docs](authn-and-authz.md) to learn how to configure other open authentication providers.

...
Rancher 使用 LDAP 与 Active Directory 服务器通信。因此，Active Directory 与 [OpenLDAP 身份验证](openldap/openldap.md)的流程相同。

:::note

在开始之前，请熟悉[外部身份验证配置和主体用户](authn-and-authz.md#外部认证配置和用户主体)的概念。

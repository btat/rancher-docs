...
> 本节假定你已了解 Rancher、Shibboleth 和 OpenLDAP 是如何协同工作的。有关工作原理的详细说明，请参见[本页](group-permissions.md)
...
配置 OpenLDAP 服务器，组和用户的设置。有关填写每个字段的帮助，请参见[配置参考](../openldap/reference.md)。请注意，嵌套组成员资格不适用于 Shibboleth。

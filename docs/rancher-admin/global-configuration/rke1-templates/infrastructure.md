...
When you create a [CIS benchmark compliant cluster,](../../../security/security-overview.md) you have an encryption config file and an audit log config file.

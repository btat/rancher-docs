...
Make sure that your node fulfills the general [installation requirements.](../../../new_docs/installation-and-upgrade/requirements/installation-requirements.md)
...
Provision a single Linux host according to our [Requirements](../../../new_docs/installation-and-upgrade/requirements/installation-requirements.md) to launch your Rancher Server.
...
- **Recommended:** Review Single Node [Backup](../../../new_docs/rancher-administration/backup-restore-and-disaster-recovery/back-up-docker-installed-rancher.md) and [Restore](../../../new_docs/rancher-administration/backup-restore-and-disaster-recovery/restore-docker-installed-rancher.md). Although you don't have any data you need to back up right now, we recommend creating backups after regular Rancher use.
- Create a Kubernetes cluster: [Provisioning Kubernetes Clusters](../../../new_docs/cluster-administration/kubernetes-clusters-in-rancher-setup/kubernetes-clusters-in-rancher-setup.md).

<br/>

## FAQ and Troubleshooting

For help troubleshooting certificates, see [this section.](../../../new_docs/installation-and-upgrade/other-installation-methods/rancher-on-a-single-node-with-docker/certificate-troubleshooting.md)

## Advanced Options

### API Auditing

If you want to record all transactions with the Rancher API, enable the [API Auditing](../../../new_docs/observability/logging/enable-api-audit-log.md) feature by adding the flags below into your install command.
...
This operation requires [privileged access](../../../new_docs/installation-and-upgrade/other-installation-methods/rancher-on-a-single-node-with-docker/rancher-on-a-single-node-with-docker.md#privileged-access-for-rancher).

...
- [Azure](../infra-providers/azure/machine-configuration.md)
- [DigitalOcean](../infra-providers/digitalocean/machine-configuration.md)
- [EC2](../infra-providers/aws/machine-configuration.md)
...
The default [pod security policy](../../security/psp/create.md) for the cluster. Please refer to the [RKE2 documentation](https://docs.rke2.io/security/pod_security_policies) on the specifications of each available policy.

##### Pod Security Admission Configuration Template

The default [pod security admission configuration template](../../security/psact.md) for the cluster.

##### Worker CIS Profile

Select a [CIS benchmark](../../security/cis-scans/how-to.md) to validate the system configuration against.
...
Option to set environment variables for [Rancher agents](../about-rancher-agents.md). The environment variables can be set using key value pairs. Refer to the [RKE2 documentation](https://docs.rke2.io/reference/linux_agent_config) for more details.

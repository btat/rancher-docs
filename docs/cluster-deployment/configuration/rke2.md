...
为集群选择默认的 [pod 安全策略](../../security/psp/create.md)。请参阅 [RKE2 文档](https://docs.rke2.io/security/pod_security_policies)来了解每个可用策略的规范。

#### Worker CIS 配置文件

选择一个 [CIS benchmark](../../security/cis-scans/how-to.md) 来验证系统配置。
...
为 [Rancher agent](../about-rancher-agents.md) 设置环境变量的选项。你可以使用键值对设置环境变量。有关详细信息，请参阅 [RKE2 文档](https://docs.rke2.io/reference/linux_agent_config)。

...
For more information, refer to the section on [hosted Kubernetes clusters.](hosted-kubernetes/hosted-kubernetes.md)
...
Using Rancher, you can create pools of nodes based on a [node template](infra-providers/infra-providers.md#node-templates). This template defines the parameters used to launch nodes in your cloud providers.
...
The cloud providers available for creating a node template are decided based on the [node drivers](infra-providers/infra-providers.md#node-drivers) active in the Rancher UI.

For more information, refer to the section on [nodes hosted by an infrastructure provider](infra-providers/infra-providers.md)

### Launching Kubernetes on Existing Custom Nodes

When setting up this type of cluster, Rancher installs Kubernetes on existing [custom nodes,](custom-clusters/custom-clusters.md) which creates a custom cluster.

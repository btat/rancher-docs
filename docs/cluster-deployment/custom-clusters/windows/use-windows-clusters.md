...
The general node requirements for networking, operating systems, and Docker are the same as the node requirements for a [Rancher installation](../../../installation-and-upgrade/requirements/requirements.md).

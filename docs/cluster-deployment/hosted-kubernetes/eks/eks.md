...
For the full list of EKS cluster configuration options, see [this page.](configuration.md)
...
The EKS provisioner can synchronize the state of an EKS cluster between Rancher and the provider. For an in-depth technical explanation of how this works, see [Syncing.](../sync-clusters.md)

For information on configuring the refresh interval, refer to [this section.](configuration.md#configuring-the-refresh-interval)

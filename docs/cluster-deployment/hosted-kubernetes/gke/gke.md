...
1. Fill out the rest of the form. For help, refer to the [GKE cluster configuration reference.](configuration.md)
1. Click **Create**.
...
Private GKE clusters are supported. Note: This advanced setup can require more steps during the cluster provisioning process. For details, see [this section.](private-clusters.md)

## Configuration Reference

For details on configuring GKE clusters in Rancher, see [this page.](configuration.md)
...
The GKE provisioner can synchronize the state of a GKE cluster between Rancher and the provider. For an in-depth technical explanation of how this works, see [Syncing.](../sync-clusters.md)

For information on configuring the refresh interval, see [this section.](configuration.md#configuring-the-refresh-interval)

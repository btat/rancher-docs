...
有关配置 vSphere 节点模板的详细信息，请参阅 [vSphere 节点模板配置参考](node-template-configuration.md)。

有关在 Rancher 中配置 RKE Kubernetes 集群的详细信息，请参阅[集群配置参考](../../configuration/rke1.md#rke-集群配置文件参考)。
...
1. 单击**创建**。
1. 单击 **VMware vSphere**。
1. 输入你的 vSphere 凭证。如需帮助，请参见[节点模板配置参考](node-template-configuration.md)中的**账号访问**。
1. 单击**创建**。
...
为 vSphere 创建[节点模板](../infra-providers.md#节点模板)会允许 Rancher 在 vSphere 中配置新节点。其他集群可以复用节点模板。
...
1. 单击**添加模板**。
1. 单击 **vSphere**。
1. 填写 vSphere 的节点模板。有关填写表格的帮助，请参阅 vSphere 节点模板[配置参考](node-template-configuration.md)。
1. 单击**创建**。
...
1. 如果你想稍后动态配置持久存储或其他基础设施，你需要修改集群 YAML 文件来启用 vSphere 云提供商。有关更多信息，请参阅[树内 vSphere cloud provider 文档](../../set-up-cloud-providers/configure-in-tree-vsphere.md)和[树外 vSphere cloud provider 文档](../../set-up-cloud-providers/configure-out-of-tree-vsphere.md)。
...
- **配置存储**：有关如何使用 Rancher 在 vSphere 中配置存储的示例，请参阅[本节](../../../cluster-admin/manage-clusters/persistent-storage/examples/examples.md)。要在 vSphere 中动态配置存储，你必须启用 vSphere 云提供商。有关更多信息，请参阅[树内 vSphere cloud provider 文档](../../set-up-cloud-providers/configure-in-tree-vsphere.md)和[树外 vSphere cloud provider 文档](../../set-up-cloud-providers/configure-out-of-tree-vsphere.md)。

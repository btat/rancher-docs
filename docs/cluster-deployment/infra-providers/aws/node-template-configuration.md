...
Your AWS account access information, stored in a [cloud credential.](../../../rancher-admin/users/settings/manage-cloud-credentials.md)
...
- [Example IAM Policy](aws.md#example-iam-policy)
- [Example IAM Policy with PassRole](aws.md#example-iam-policy-with-passrole) (needed if you want to use [Kubernetes Cloud Provider](../../set-up-cloud-providers/set-up-cloud-providers.md) or want to pass an IAM Profile to an instance)
- [Example IAM Policy to allow encrypted EBS volumes](aws.md#example-iam-policy-to-allow-encrypted-ebs-volumes) policy to an user.
...
If you need to pass an **IAM Instance Profile Name** (not ARN), for example, when you want to use a [Kubernetes Cloud Provider](../../set-up-cloud-providers/set-up-cloud-providers.md), you will need an additional permission in your policy. See [Example IAM policy with PassRole](aws.md#example-iam-policy-with-passrole) for an example policy.

...
While creating an [Amazon EC2 cluster](../infra-providers/aws/aws.md), you must fill in the **IAM Instance Profile Name** (not ARN) of the created IAM role when creating the **Node Template**.

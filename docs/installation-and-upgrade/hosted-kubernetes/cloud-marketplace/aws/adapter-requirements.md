...
Follow the [Rancher docs](../../rancher-on-amazon-eks.md) to create an EKS cluster. When you get to the [final step to install Rancher](../../rancher-on-amazon-eks.md#8-install-the-rancher-helm-chart), **stop and return to this page**. This cluster will need to meet the following requirements:
...
In addition to the options specified to install Rancher in the [Rancher docs](../../rancher-on-amazon-eks.md#8-install-the-rancher-helm-chart), you will also need to enable extra metrics.

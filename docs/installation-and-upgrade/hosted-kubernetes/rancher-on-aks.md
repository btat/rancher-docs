...
如果你已有一个 AKS Kubernetes 集群，请直接跳到[安装 Ingress](#5-安装-ingress) 的步骤，然后按照[此页](../install-rancher.md#安装-rancher-helm-chart)的说明安装 Rancher Helm Chart。
...
- 你的订阅有足够的配额，至少有 2 个 vCPU。有关 Rancher Server 资源要求的详情，请参见[此节](../requirements/requirements.md)。

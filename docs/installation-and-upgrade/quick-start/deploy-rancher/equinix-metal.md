...
The intent of these guides is to quickly launch a sandbox that you can use to evaluate Rancher. The Docker install is not recommended for production environments. For comprehensive setup instructions, see [Installation](../../installation-and-upgrade.md).
...
- For a full list of port requirements, refer to [Docker Installation](../../../cluster-deployment/node-requirements.md).
- Provision the host according to our [Requirements](../../requirements/installation-requirements.md).

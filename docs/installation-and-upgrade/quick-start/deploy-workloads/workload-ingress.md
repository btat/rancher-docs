...
1. 在 `Service Type` 点击 **Add Port** 和 `Cluster IP`，并在 **Private Container Port** 字段中输入`80`。你可以将 `Name` 留空或指定名称。通过添加端口，你可以访问集群内外的应用。有关详细信息，请参阅 [Service](../../../cluster-admin/kubernetes-resources/workloads-and-pods/workloads-and-pods.md#services)。
1. 单击**创建**。
...
- [Amazon AWS：销毁环境](../../../getting-started/quick-start-guides/deploy-rancher-manager/aws.md#销毁环境)
- [DigitalOcean：销毁环境](../../../getting-started/quick-start-guides/deploy-rancher-manager/digitalocean.md#销毁环境)
- [Vagrant：销毁环境](../../../getting-started/quick-start-guides/deploy-rancher-manager/vagrant.md#销毁环境)

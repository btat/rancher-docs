...
1. Click **Add Port** and `Cluster IP` for the `Service Type` and enter `80` in the **Private Container Port** field. You may leave the `Name` blank or specify any name that you wish. Adding a port enables access to the application inside and outside of the cluster. For more information, see [Services](../../../cluster-admin/kubernetes-resources/workloads-and-pods/workloads-and-pods.md#services).
1. Click **Create**.
...
- [Amazon AWS: Destroying the Environment](../../../getting-started/quick-start-guides/deploy-rancher-manager/aws.md#destroying-the-environment)
- [DigitalOcean: Destroying the Environment](../../../getting-started/quick-start-guides/deploy-rancher-manager/digitalocean.md#destroying-the-environment)
- [Linode: Destroying the Environment](../../../getting-started/quick-start-guides/deploy-rancher-manager/linode.md#destroying-the-environment)
- [Vagrant: Destroying the Environment](../../../getting-started/quick-start-guides/deploy-rancher-manager/vagrant.md#destroying-the-environment)

...
如果你在 vSphere 环境中安装 Rancher，请参见[最佳实践文档](rancher-on-vsphere.md)。
...
## 监控集群以规划容量
Rancher Server 的 Kubernetes 集群应该尽可能满足[系统和硬件要求](../requirements/requirements.md)。越偏离系统和硬件要求，你可能面临的风险就越大。
...
在集群中[启用监控](../../observability/monitoring-and-dashboards/monitoring-and-alerting.md)后，你可以通过设置告警通知，来了解集群容量的使用情况。你还可以使用 Prometheus 和 Grafana 监控框架，在你扩容时建立关键指标的基线。

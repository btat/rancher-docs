...
Alternatively, in order to make such changes permanent, these environment variables can be set by [using Helm values](../references/helm-chart-options.md#setting-extra-environment-variables) instead.

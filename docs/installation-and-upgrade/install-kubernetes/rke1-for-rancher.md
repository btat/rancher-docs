...
如果系统无法直接访问互联网，请参见[离线环境：Kubernetes 安装](../other-installation-methods/air-gapped/air-gapped.md)。
...
要为大规模 Rancher 安装优化 etcd 集群，请参见 [etcd 设置指南](../best-practices/tuning-etcd-for-large-installs.md)。

有关 Dockershim 支持的详情，请参见[此页面](../requirements/dockershim.md)。

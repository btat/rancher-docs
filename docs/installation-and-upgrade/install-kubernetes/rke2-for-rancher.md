...
These instructions assume you have set up three nodes, a load balancer, and a DNS record, as described in [this section.](../infrastructure-setupp/ha-rke2-kubernetes-cluster.md)

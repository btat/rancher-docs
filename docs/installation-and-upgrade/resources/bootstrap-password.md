...
You can [customize the minimum password length](../../rancher-admin/users/authn-and-authz/manage-users-and-groups.md#minimum-password-length) for user accounts, within limitations.
...
During [Rancher installation](../install-rancher.md), set `bootstrapPassword` alongside any other flags for the Rancher Helm chart. For example:
...
Pass the following value to the [Docker install command](../../getting-started/installation-and-upgrade/other-installation-methods/air-gapped-helm-cli-install/docker-install-commands.md):

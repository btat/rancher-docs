...
Make sure that your node fulfills the general [installation requirements.](../requirements/requirements.md)
...
Provision a single Linux host according to our [Requirements](../requirements/requirements.md) to launch your Rancher Server.

...
- Create a Kubernetes cluster: [Provisioning Kubernetes Clusters](../../cluster-deployment/cluster-deployment.md).

<br/>

## FAQ and Troubleshooting

For help troubleshooting certificates, see [this section.](../troubleshooting/certificate-troubleshooting.md)

## Advanced Options

### API Auditing

If you want to record all transactions with the Rancher API, enable the [API Auditing](../../observability/logging/enable-api-audit-log.md) feature by adding the flags below into your install command.
...
If you are visiting this page to complete an [Air Gap Installation](../other-installation-methods/air-gapped/air-gapped.md), you must pre-pend your private registry URL to the server tag when running the installation command in the option that you choose. Add `<REGISTRY.DOMAIN.COM:PORT>` with your private registry URL in front of `rancher/rancher:latest`.

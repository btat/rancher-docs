...
如果你想使用 Docker 命令进行离线安装，请跳过本页的剩余部分，并按照[此页](../../../getting-started/installation-and-upgrade/other-installation-methods/air-gapped-helm-cli-install/docker-install-commands.md)进行操作。
...
1. 如果你还没有安装 `helm`，请在可访问互联网的工作站上进行本地安装。注意：参考 [Helm 版本要求](../../requirements/helm-version-requirements.md)选择 Helm 版本来安装 Rancher。

2. 执行 `helm repo add` 命令，以添加包含安装 Rancher 的 Chart 的 Helm Chart 仓库。有关如何选择仓库，以及哪个仓库最适合你的用例，请参见[选择 Rancher 版本](../../../getting-started/installation-and-upgrade/resources/choose-a-rancher-version.md)。
   - Latest：建议用于试用最新功能
      ```
...
首先，参见[添加 TLS 密文](../../resources/tls-secrets.md)发布证书文件，以便 Rancher 和 Ingress Controller 可以使用它们。
...
- [Rancher Helm Chart 选项](../../references/helm-chart-options.md)
- [添加 TLS 密文](../../resources/tls-secrets.md)
- [Rancher Kubernetes 安装的故障排除](../../troubleshooting/troubleshooting.md)

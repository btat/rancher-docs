...
These instructions assume you have already followed the instructions for a Kubernetes upgrade on [this page,](../../installation/upgrades.md) including the prerequisites, up until step 3. Upgrade Rancher.

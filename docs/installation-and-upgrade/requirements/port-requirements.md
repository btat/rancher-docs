...
The port requirements differ depending on how the downstream cluster was launched. Each of the tabs below list the ports that need to be opened for different [cluster types](../../cluster-deployment/cluster-deployment.md).

The following diagram depicts the ports that are opened for each [cluster type](../../cluster-deployment/cluster-deployment.md).
...
Refer to the [Harvester Integration Overview](../../integrations/harvester/overview.md#port-requirements) for more information on Harvester port requirements.
...
The following table depicts the port requirements for [Rancher Launched Kubernetes](../../cluster-deployment/launch-kubernetes-with-rancher.md) with nodes created in an [Infrastructure Provider](../../cluster-deployment/infra-providers/infra-providers.md).
...
The following table depicts the port requirements for [Rancher Launched Kubernetes](../../cluster-deployment/launch-kubernetes-with-rancher.md) with [Custom Nodes](../../cluster-deployment/custom-clusters/custom-clusters.md).
...
The following table depicts the port requirements for [hosted clusters](../../cluster-deployment/hosted-kubernetes/hosted-kubernetes.md).
...
The following table depicts the port requirements for [registered clusters](../../cluster-deployment/register-existing-clusters.md).
...
When using the [AWS EC2 node driver](../../cluster-deployment/infra-providers/aws/aws.md) to provision cluster nodes in Rancher, you can choose to let Rancher create a security group called `rancher-nodes`. The following rules are automatically added to this security group.

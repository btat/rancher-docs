...
For [air-gapped installs only,](../other-installation-methods/air-gapped/air-gapped.md) collect and populate images for the new Rancher server version. Follow the guide to [populate your private registry](../other-installation-methods/air-gapped/publish-images.md) with the images for the Rancher version that you want to upgrade to.
...
Use the [backup application](../../rancher-admin/back-up-restore-and-disaster-recovery/back-up.md) to back up Rancher.
...
If you are installing Rancher in an air-gapped environment, skip the rest of this page and render the Helm template by following the instructions on [this page.](../other-installation-methods/air-gapped/upgrades.md)

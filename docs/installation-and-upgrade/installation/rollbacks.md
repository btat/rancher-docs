...
* Follow these steps to [migrate Rancher](../../rancher-admin/back-up-restore-and-disaster-recovery/migrate-to-a-new-cluster.md).
* If you need to restore Rancher to its previous state at the same Rancher version, see the [restore documentation](../../rancher-admin/back-up-restore-and-disaster-recovery/restore.md).
...
Follow these [instructions](../../rancher-admin/back-up-restore-and-disaster-recovery/migrate-to-a-new-cluster.md) to install the Rancher-Backup Helm chart and restore Rancher to its previous state.

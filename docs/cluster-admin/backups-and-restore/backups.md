...
In the Rancher UI, etcd backup and recovery for [Rancher launched Kubernetes clusters](../../cluster-deployment/launch-kubernetes-with-rancher.md) can be easily performed.

...
- The options below are available for [Rancher-launched Kubernetes clusters](../../cluster-deployment/launch-kubernetes-with-rancher.md) and [Registered K3s Kubernetes clusters](../../cluster-deployment/register-existing-clusters.md#additional-features-for-registered-rke2-and-k3s-clusters).
...
- Before upgrading Kubernetes, [back up your cluster.](../../rancher-admin/back-up-restore-and-disaster-recovery/back-up-restore-and-disaster-recovery.md)
...
- [Backing up a cluster](backups.md#how-snapshots-work)
- [Restoring a cluster from backup](restore.md#restoring-a-cluster-from-a-snapshot)
...
1. Configure the options for how pods are deleted. For more information about each option, refer to [this section.](../manage-clusters/nodes-and-node-pools.md#aggressive-and-safe-draining-options)

...
默认情况下，管理员或具有**管理集群驱动**[全局角色](../../rancher-admin/users/authn-and-authz/manage-role-based-access-control-rbac/global-permissions.md)的用户，可以刷新 Kubernetes 元数据。
...
1. 使用[离线环境安装](../../installation-and-upgrade/other-installation-methods/air-gapped/publish-images.md)时使用的步骤准备私有镜像仓库，但不要使用发布页面中的 `rancher-images.txt`，而是使用上一个步骤中获取的文件。

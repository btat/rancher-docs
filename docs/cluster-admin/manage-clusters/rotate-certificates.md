...
For users who didn't rotate their webhook certificates, and they have expired after one year, please see this [page](../../security/rancher-webhook/expired-webhook-certificate-rotation.md) for help.

...
- 要将持久卷创建为 Kubernetes 资源，你必须具有`管理卷`的[角色。](../../../rancher-admin/users/authn-and-authz/manage-role-based-access-control-rbac/cluster-and-project-roles.md#项目角色参考)
...
设置持久存储设备的步骤会因你的基础设施而异。我们提供了使用 [vSphere](examples/vsphere-storage.md)、[NFS](examples/nfs-storage.md) 或 [Amazon EBS ](examples/persistent-storage-in-amazon-ebs.md)设置存储的示例。

...
- To create a persistent volume as a Kubernetes resource, you must have the `Manage Volumes` [role.](../../../rancher-admin/users/authn-and-authz/manage-role-based-access-control-rbac/cluster-and-project-roles.md#project-role-reference)
...
The steps to set up a persistent storage device will differ based on your infrastructure. We provide examples of how to set up storage using [vSphere,](examples/vsphere-storage.md) [NFS,](examples/nfs-storage.md) or Amazon's [EBS.](examples/persistent-storage-in-amazon-ebs.md)

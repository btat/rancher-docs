...
For a list of skipped and not applicable tests, refer to [this page](skip-tests.md).
...
Please refer to the [CIS Scan Guides](how-to.md) to learn how to run CIS scans.

...
This section describes how to use `firewalld` to apply the [firewall port rules](../installation-and-upgrade/requirements/installation-requirements.md#port-requirements) for nodes in a high-availability Rancher server cluster.

...
Yes. See our [Cluster Administration](../cluster-admin/manage-clusters/manage-clusters.md) guide for what Rancher features are available on AKS, as well as our [documentation on AKS](../installation-and-upgrade/hosted-kubernetes/rancher-on-aks.md).

## Does Rancher support Windows?

Yes. Rancher supports Windows Server 1809 containers. For details on how to set up a cluster with Windows worker nodes, refer to the section on [configuring custom clusters for Windows.](../cluster-deployment/custom-clusters/windows/use-windows-clusters.md)

## Does Rancher support Istio?

Yes. Rancher supports [Istio](../observability/istio/istio.md).

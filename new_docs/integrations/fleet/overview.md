...
For details on support for clusters with Windows nodes, see the [Windows Support](../../../docs/integrations-in-rancher/fleet/windows-support.md) page.
...
For details on using Fleet behind a proxy, see the [Using Fleet Behind a Proxy](../../../docs/integrations-in-rancher/fleet/use-fleet-behind-a-proxy.md) page.

...
For systems without direct internet access, refer to [Air Gap: Kubernetes install.](../../installation-and-upgrade/other-installation-methods/air-gapped-helm-cli-install/air-gapped-helm-cli-install.md)
...
For tuning your etcd cluster for larger Rancher installations, see the [etcd settings guide](../../installation-and-upgrade/tune-etcd-for-large-installs.md).

For more information regarding Dockershim support, refer to [this page](../../installation-and-upgrade/requirements/dockershim.md)
...
See the [Troubleshooting](../../installation-and-upgrade/installation/troubleshooting.md) page.


### [Next: Install Rancher](../../installation-and-upgrade/installation/install-upgrade-on-a-kubernetes-cluster.md)

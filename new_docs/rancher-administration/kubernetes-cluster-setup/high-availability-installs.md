...
For information on how Rancher works, regardless of the installation method, refer to the [architecture section.](../../about-rancher/architecture/architecture.md)

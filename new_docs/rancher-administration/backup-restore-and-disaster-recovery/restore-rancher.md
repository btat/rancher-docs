...
* Follow those steps to [migrate Rancher](../../../docs/how-to-guides/new-user-guides/backup-restore-and-disaster-recovery/migrate-rancher-to-new-cluster.md).
* If you need to restore Rancher to a previous version after an upgrade, see the [rollback documentation](../../installation-and-upgrade/installation/rollbacks.md).
...
1. Click **Create**.
1. Create the Restore with the form, or with YAML.  For creating the Restore resource using form, refer to the [configuration reference](../rancher-backup-restore-configuration/restore-configuration.md) and to the [examples.](../rancher-backup-restore-configuration/examples.md)
1. For using the YAML editor, we can click **Create > Create from YAML**. Enter the Restore YAML.
    ...
    ```
      ...
      For help configuring the Restore, refer to the [configuration reference](../rancher-backup-restore-configuration/restore-configuration.md) and to the [examples.](../rancher-backup-restore-configuration/examples.md)

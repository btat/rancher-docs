...
Admins should create a [Rancher backup](../../../../docs/how-to-guides/new-user-guides/backup-restore-and-disaster-recovery/back-up-rancher.md) before they commit to the endpoint migration described below.
...
1. Admins are encouraged to use the proper restore process if they want to go back. Please see [backup docs](../../../../docs/how-to-guides/new-user-guides/backup-restore-and-disaster-recovery/back-up-rancher.md), [restore docs](../../../../docs/how-to-guides/new-user-guides/backup-restore-and-disaster-recovery/restore-rancher.md), and [examples](../../../../docs/reference-guides/backup-restore-configuration/examples.md) for reference.

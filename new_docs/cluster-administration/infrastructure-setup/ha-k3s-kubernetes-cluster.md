...
For more information about each installation option, refer to [this page.](../../installation-and-upgrade/installation-and-upgrade.md)
...
Make sure that your nodes fulfill the general installation requirements for [OS, container runtime, hardware, and networking.](../../installation-and-upgrade/requirements/installation-requirements.md)
...
For an example of one way to set up the MySQL database, refer to this [tutorial](../../../docs/how-to-guides/new-user-guides/infrastructure-setup/mysql-database-in-amazon-rds.md) for setting up MySQL on Amazon's RDS service.

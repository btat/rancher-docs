...
For more information on adding secret to a workload, see [Deploying Workloads](../../../docs/how-to-guides/new-user-guides/kubernetes-resources-setup/workloads-and-pods/deploy-workloads.md).

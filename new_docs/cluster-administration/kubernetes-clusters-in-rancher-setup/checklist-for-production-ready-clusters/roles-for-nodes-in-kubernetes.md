...
This diagram is applicable to Kubernetes clusters [launched with Rancher using RKE.](../../../../docs/how-to-guides/new-user-guides/launch-kubernetes-with-rancher/launch-kubernetes-with-rancher.md).

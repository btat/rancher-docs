...
If you plan to use ARM64, see [Running on ARM64 (Experimental).](../../rancher-administration/enable-experimental-features/rancher-on-arm64.md)
...
The Docker service is enabled automatically when using [Node Drivers](../../rancher-administration/authentication-permissions-and-global-configuration/about-provisioning-drivers/about-provisioning-drivers.md#node-drivers).

### Windows Nodes

Nodes with Windows Server must run Docker Enterprise Edition.

Windows nodes can be used for worker nodes only. See [Configuring Custom Clusters for Windows](../../../docs/how-to-guides/new-user-guides/kubernetes-clusters-in-rancher-setup/use-windows-clusters/use-windows-clusters.md)
...
For more information on the hardening guide and details on which version of the guide corresponds to your Rancher and Kubernetes versions, refer to the [security section.](../../../docs/reference-guides/rancher-security/rancher-security.md#rancher-hardening-guide)

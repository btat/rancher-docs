...
For the full list of EKS cluster configuration options, see [this page.](../../../installation-and-upgrade/rancher-server-configuration/eks-cluster-configuration.md)
...
The EKS provisioner can synchronize the state of an EKS cluster between Rancher and the provider. For an in-depth technical explanation of how this works, see [Syncing.](../../../installation-and-upgrade/rancher-server-configuration/sync-clusters.md)

For information on configuring the refresh interval, refer to [this section.](../../../installation-and-upgrade/rancher-server-configuration/eks-cluster-configuration.md#configuring-the-refresh-interval)

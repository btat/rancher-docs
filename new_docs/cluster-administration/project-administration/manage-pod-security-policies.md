...
These cluster options are only available for [clusters in which Rancher has launched Kubernetes](../launch-kubernetes-with-rancher/launch-kubernetes-with-rancher.md).

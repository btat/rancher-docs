...
Resource quotas can also be set when a new project is created. For details, refer to the section on [creating new projects.](../../manage-clusters/projects-and-namespaces.md#creating-projects)
...
1. Select a Resource Type. For more information on types, see the [quota type reference.](../../../../docs/how-to-guides/advanced-user-guides/manage-projects/manage-project-resource-quotas/resource-quota-types.md)

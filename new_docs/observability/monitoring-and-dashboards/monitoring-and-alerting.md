...
For more information on configuring access to monitoring, see [this page.](../../../docs/integrations-in-rancher/monitoring-and-alerting/rbac-for-monitoring.md)

:::note

Rancher and Project read permissions don't necessarily apply to monitoring resources. See [monitoring-ui-view](../../../docs/integrations-in-rancher/monitoring-and-alerting/rbac-for-monitoring.md#additional-monitoring-clusterroles) for more details.

:::

## Guides

- [Enable monitoring](../../../docs/how-to-guides/advanced-user-guides/monitoring-alerting-guides/enable-monitoring.md)
- [Uninstall monitoring](../../../docs/how-to-guides/advanced-user-guides/monitoring-alerting-guides/uninstall-monitoring.md)
- [Monitoring workloads](../../../docs/how-to-guides/advanced-user-guides/monitoring-alerting-guides/set-up-monitoring-for-workloads.md)
- [Customizing Grafana dashboards](../../../docs/how-to-guides/advanced-user-guides/monitoring-alerting-guides/customize-grafana-dashboard.md)
- [Persistent Grafana dashboards](../../../docs/how-to-guides/advanced-user-guides/monitoring-alerting-guides/create-persistent-grafana-dashboard.md)
- [Debugging high memory usage](../../../docs/how-to-guides/advanced-user-guides/monitoring-alerting-guides/debug-high-memory-usage.md)
...
- [ServiceMonitor and PodMonitor](../../../docs/reference-guides/monitoring-v2-configuration/servicemonitors-and-podmonitors.md)
- [Receiver](../../../docs/reference-guides/monitoring-v2-configuration/receivers.md)
- [Route](../../../docs/reference-guides/monitoring-v2-configuration/routes.md)
- [PrometheusRule](../../../docs/how-to-guides/advanced-user-guides/monitoring-v2-configuration-guides/advanced-configuration/prometheusrules.md)
- [Prometheus](../../../docs/how-to-guides/advanced-user-guides/monitoring-v2-configuration-guides/advanced-configuration/prometheus.md)
- [Alertmanager](../../../docs/how-to-guides/advanced-user-guides/monitoring-v2-configuration-guides/advanced-configuration/alertmanager.md)

### Configuring Helm Chart Options

For more information on `rancher-monitoring` chart options, including options to set resource limits and requests, see [Helm Chart Options](../../../docs/reference-guides/monitoring-v2-configuration/helm-chart-options.md).
...
For more details on how to upgrade wins on existing Windows hosts, see [Windows cluster support for Monitoring V2.](../../../docs/integrations-in-rancher/monitoring-and-alerting/windows-support.md).
...
See [Debugging High Memory Usage](../../../docs/how-to-guides/advanced-user-guides/monitoring-alerting-guides/debug-high-memory-usage.md) for advice and recommendations.

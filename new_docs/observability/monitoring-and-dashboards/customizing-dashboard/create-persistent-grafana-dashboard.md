...
- To see the links to the external monitoring UIs, including Grafana dashboards, you will need at least a [project-member role.](../rbac-for-monitoring.md#users-with-rancher-based-permissions)

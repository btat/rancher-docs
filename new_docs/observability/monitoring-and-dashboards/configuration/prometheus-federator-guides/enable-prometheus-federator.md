...
By default, Prometheus Federator is configured and intended to be deployed alongside [rancher-monitoring](../../../../../docs/how-to-guides/advanced-user-guides/monitoring-and-alerting.md), which deploys Prometheus Operator alongside a Cluster Prometheus that each Project Monitoring Stack is configured to federate namespace-scoped metrics from by default.

For instructions on installing rancher-monitoring, refer to [this page](../../../../../docs/how-to-guides/advanced-user-guides/enable-monitoring.md).

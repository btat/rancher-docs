...
For more information, refer to the logging documentation [here.](../../docs/integrations-in-rancher/logging/logging.md)
...
For more information, refer to the monitoring documentation [here.](../../docs/integrations-in-rancher/monitoring-and-alerting/monitoring-and-alerting.md)
...
For more information, refer to the Istio documentation [here.](../../docs/integrations-in-rancher/istio/istio.md)

## OPA Gatekeeper

<DeprecationOPAGatekeeper link="../integrations-in-rancher/kubewarden" />

[OPA Gatekeeper](https://github.com/open-policy-agent/gatekeeper) is an open-source project that provides integration between OPA and Kubernetes to provide policy control via admission controller webhooks. For details on how to enable Gatekeeper in Rancher, refer to the [OPA Gatekeeper section.](../../docs/integrations-in-rancher/opa-gatekeeper.md)

## CIS Scans

Rancher can run a security scan to check whether Kubernetes is deployed according to security best practices as defined in the CIS Kubernetes Benchmark.

For more information, refer to the CIS scan documentation [here.](../../docs/how-to-guides/advanced-user-guides/cis-scan-guides/cis-scan-guides.md)
...
As a prerequisite, you must create a [secret](../../cluster-administration/kubernetes-resources/secrets.md) or [configmap](../../cluster-administration/kubernetes-resources/configmaps.md) to be the source of the audit policy.
...
For more information about cluster configuration, refer to the [RKE2 cluster configuration reference](../../installation-and-upgrade/rancher-server-configuration/rke2-cluster-configuration.md) pages.
...
Rancher Dashboard provides an easy-to-use form for creating the [secret](../../cluster-administration/kubernetes-resources/secrets.md) or [configmap](../../cluster-administration/kubernetes-resources/configmaps.md).
...
For more information about cluster configuration, refer to the [K3s cluster configuration reference](../../installation-and-upgrade/rancher-server-configuration/k3s-cluster-configuration.md) pages.

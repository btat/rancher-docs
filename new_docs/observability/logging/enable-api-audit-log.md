...
- [Docker Install](../../../docs/reference-guides/single-node-rancher-in-docker/advanced-options.md#api-audit-log)

- [Kubernetes Install](../../installation-and-upgrade/installation-references/helm-chart-options.md#api-audit-log)
...
You can enable Rancher's built in log collection and shipping for the cluster to ship the audit and other services logs to a supported collection endpoint. See [Rancher Tools - Logging](logging.md) for details.

...
| Cloud Credentials | Select the cloud credentials that you created for your IAM policy. For more information on creating cloud credentials in Rancher, refer to [this page.](../../../docs/reference-guides/user-settings/manage-cloud-credentials.md) |

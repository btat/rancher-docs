...
To resolve the issue, set the `agent-tls-mode` to `system-store` or upload the CA for Rancher as described in [Adding TLS Secrets](../../../docs/getting-started/installation-and-upgrade/resources/add-tls-secrets.md).

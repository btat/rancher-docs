...
This page covers installing Rancher on an Amazon EKS cluster.  You can also [install Rancher through the AWS Marketplace](../../../docs/getting-started/quick-start-guides/deploy-rancher-manager/aws-marketplace.md).

...
See [Docker Install with an External Load Balancer](../../../../docs/how-to-guides/advanced-user-guides/configure-layer-7-nginx-load-balancer.md) instead.
...
Make sure that your node fulfills the general [installation requirements.](../../requirements/installation-requirements.md)

## 1. Provision Linux Host

Provision a single Linux host according to our [Requirements](../../requirements/installation-requirements.md) to launch your Rancher server.
...
- Use a proxy? See [HTTP Proxy Configuration](../../../../docs/reference-guides/single-node-rancher-in-docker/http-proxy-configuration.md)
- Configure custom CA root certificate to access your services? See [Custom CA root certificate](../../../../docs/reference-guides/single-node-rancher-in-docker/advanced-options.md#custom-ca-certificate/)
- Complete an Air Gap Installation? See [Air Gap: Docker Install](../air-gapped-helm-cli-install/air-gapped-helm-cli-install.md)
- Record all transactions with the Rancher API? See [API Auditing](../../../../docs/reference-guides/single-node-rancher-in-docker/advanced-options.md#api-audit-log)
...
Refer to [this page](../../../../docs/reference-guides/single-node-rancher-in-docker/advanced-options.md) for details.
...
- **Recommended:** Review Single Node [Backup](../../../../docs/how-to-guides/new-user-guides/backup-restore-and-disaster-recovery/back-up-docker-installed-rancher.md) and [Restore](../../../../docs/how-to-guides/new-user-guides/backup-restore-and-disaster-recovery/restore-docker-installed-rancher.md). Although you don't have any data you need to back up right now, we recommend creating backups after regular Rancher use.
- Create a Kubernetes cluster: [Provisioning Kubernetes Clusters](../../../../docs/how-to-guides/new-user-guides/kubernetes-clusters-in-rancher-setup/kubernetes-clusters-in-rancher-setup.md).

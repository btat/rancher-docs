...
By default, all images used to [provision Kubernetes clusters](../../../../docs/how-to-guides/new-user-guides/kubernetes-clusters-in-rancher-setup/kubernetes-clusters-in-rancher-setup.md) or launch any tools in Rancher, e.g. monitoring, pipelines, alerts, are pulled from Docker Hub. In an air gapped installation of Rancher, you will need a private registry that is located somewhere accessible by your Rancher server. Then, you will load the registry with all the images.
...
1.  Fetch the latest `cert-manager` Helm chart and parse the template for image details:
    ...
    Recent changes to cert-manager require an upgrade. If you are upgrading Rancher and using a version of cert-manager older than v0.12.0, please see our [upgrade documentation](../../../../docs/getting-started/installation-and-upgrade/resources/upgrade-cert-manager.md).
